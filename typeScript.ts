...
function criarSquare(row: number, column: number): Square {
  return {
    row,
    column,
    state: "closed",
...
function sortearMinas(matriz: CampoMinado, quantidadeMinas: number): void {
...
function contarBombasVizinhas(matriz: CampoMinado, linha: number, coluna: number): void {
...
function atualizarBombasCampo(matriz: CampoMinado): void {
...
function imprimirMatriz(matriz: CampoMinado): void {
